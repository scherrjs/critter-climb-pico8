# This upload contains all of the code required to run Critter Climb, as well as the .p8 file called squirrel.p8 which contains the code, sprites, and music required to run the game.
